      ...
      <div className="h-full flex flex-col" style={{ minHeight: '100vh' }}>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <h2 className="text-xl font-semibold mb-2">{t('main.loading')}</h2>
            <p>{t('main.settingUpWorkspace')}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center text-gray-500 dark:text-gray-400 max-w-md mx-auto px-6">
            ...
            <h2 className="text-2xl font-semibold mb-3 text-gray-900 dark:text-white">{t('main.chooseProject')}</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              {t('main.chooseProjectDesc')}
            </p>
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
              <p className="text-sm text-blue-700 dark:text-blue-300">
                💡 <strong>Tip:</strong> {isMobile ? t('main.tipMobile') : t('main.tipDesktop')}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="min-w-0">
              {activeTab === 'chat' && selectedSession ? (
                ...
                <div>
                  <h2 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">
                    {activeTab === 'files' ? t('main.projectFiles') : activeTab === 'git' ? t('main.sourceControl') : t('tabs.chat')}
                  </h2>
                  <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                    {selectedProject.displayName}
                  </div>
            ...
            <div className="relative flex bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
              ...
              >
                <span className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="hidden sm:inline">{t('tabs.shell')}</span>
                </span>
              </button>
              <button
              ...
              >
                <span className="flex items-center gap-1 sm:gap-1.5">
                  ...
                  <span className="hidden sm:inline">{t('tabs.sourceControl')}</span>
                </span>
              </button>
               {/* <button
